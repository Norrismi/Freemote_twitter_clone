...
//console.log(getUser(user.typedUser))


//console.log(`the user is ${user.typedUser}`)
        ...
        // for(i=0; i<=users.typedUser.tweets.length; i++) {
          
        // }
        // `
        //                     <div class='twt_card'>
        //                     <img class='elon_avatar' src=${users.typedUser.avatarURL} >
        //                     <div class='text_info'>
        
        //                     <div class='text_name'>
        //                         <b>${users.typedUser.displayName}</b>
        //                         <div class='text_info-username'>${users.typedUser.userName}</div>
        //                         <div class='text_info-time'><span class=''>&#8226;</span>${moment([users.typedUser.tweets[i].timestamp],'MM').fromNow()}</div>
        //                         <i class="fas fa-ellipsis-h"></i>
